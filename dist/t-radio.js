(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash.isequal'), require('vue'), require('lodash.get')) :
    typeof define === 'function' && define.amd ? define(['exports', 'lodash.isequal', 'vue', 'lodash.get'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TRadio = {}, global.isEqual, global.Vue, global.get));
})(this, (function (exports, isEqual, Vue, get) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    const checkIfTagShouldBeChecked = (model, checked, value) => (model === undefined ? !!checked : isEqual(model, value));
    ...
    exports.default = TRadio;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=t-radio.js.map
